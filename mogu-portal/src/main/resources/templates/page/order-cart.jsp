...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/mogu-logo.png" alt="蘑菇商城" width="200px" height="80px"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="陈莫"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="人民路XXXXXXXXX号"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">陈莫</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">156****6666</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">四川 成都 双流区</div>
						<div class="adr-m" limit="30">人民路  xxxxxxxxx</div>
			...
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">蘑菇快递<i
						class='qmark-icon qmark-tip'
						data-tips='由蘑菇公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由蘑菇配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
