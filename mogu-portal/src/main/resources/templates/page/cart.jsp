...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/mogu-logo.png" title="返回蘑菇商城首页" alt="返回蘑菇商城首页"  width="200px" height="80px"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">蘑菇价</div>
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
        	...
        	<c:set var="totalCount"  value="${ totalCount + cart.count }"/>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去蘑菇国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去蘑菇结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
